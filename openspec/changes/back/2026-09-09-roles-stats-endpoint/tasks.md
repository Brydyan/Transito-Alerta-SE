...
- [ ] **S.2.2** Verificar que `userRepo` ya está inyectado.
...
- [ ] **S.5.1** `cd backend && pnpm test` — todos los
  suites verdes (+3-4 tests nuevos)
- [ ] **S.5.2** `pnpm run lint` — 0 errores nuevos
- [ ] **S.5.3** `pnpm run typecheck` — 0 errores
- [ ] **S.5.4** `pnpm run build` — sin errores
...
- [ ] **S.6.2** Verificar que `takeUntilDestroyed` y
