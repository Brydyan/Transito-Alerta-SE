...
- [ ] **T7.9.Z1** — Registrar 0041 en `database/MIGRATION_LOG.md` _(30min)_
...
- [ ] **T7.9.Z2** — Re-anclar R21 a 0041 en specs _(45min)_
...
- [ ] **T7.9.Z3** — Actualizar `docs/tasks/3-DATABASE-SCHEMA.md` _(30min)_
...
- [ ] **T7.9.Z4** — Verificación completa de CI _(1h)_
...
- [ ] **T7.9.Z5** — Redactar manual del operador _(45min)_
...
| Z4 (CI verify) | 1h | C+D completo | GATE |
