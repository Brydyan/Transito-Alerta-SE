...
<head>
    ...
    <title>Te invitaron al sistema</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 24px 32px;">
                            ...
                            <p style="margin: 0 0 16px; font-size: 16px; line-height: 1.5;">
                                Un administrador te creó una cuenta en el
                                <strong>Sistema de Incidencias Georreferenciadas</strong>.
                                Para activar tu cuenta debés aceptar los Términos y Condiciones
                                y establecer tu contraseña haciendo clic en el siguiente enlace:
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin: 24px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $acceptUrl }}"
                                           style="display: inline-block; background-color: #1d4ed8; color: #ffffff; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-size: 16px; font-weight: 600;">
                                            Activar mi cuenta
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="margin: 16px 0 8px; font-size: 14px; color: #6b7280; line-height: 1.5;">
