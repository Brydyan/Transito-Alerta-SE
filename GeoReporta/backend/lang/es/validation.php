...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor de :attribute aparece en una filtración de datos. Elija un valor diferente para :attribute.',
    ],
    ...
    'custom' => [
        'geom' => [
            'shape' => 'El campo :attribute no tiene la forma esperada.',
        ],
    ],

    'attributes' => [
        'geom' => 'ubicación geográfica',
        'incident_category_id' => 'categoría',
        'location_id' => 'ubicación territorial',
        'priority' => 'prioridad',
        'title' => 'título',
