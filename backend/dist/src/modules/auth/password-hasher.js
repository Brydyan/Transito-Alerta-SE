...
exports.PasswordHasher = exports.DUMMY_HASH = void 0;
const bcrypt = __importStar(require("bcrypt"));
const common_1 = require("@nestjs/common");
const config_1 = require("@nestjs/config");
exports.DUMMY_HASH = bcrypt.hashSync('dummy-password-for-timing-equalization', 10);
let PasswordHasher = class PasswordHasher {
    constructor(configService) {
        this.configService = configService;
    }
    get cost() {
        return this.configService.get('auth').bcryptCost;
    }
    async hash(password) {
