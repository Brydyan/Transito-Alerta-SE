...
__decorate([
    ...
    (0, class_validator_1.MinLength)(12, { message: 'La contraseña debe tener al menos 12 caracteres' }),
    (0, class_validator_1.MaxLength)(128),
    (0, class_validator_1.Matches)(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*()_+\-=[\]{};':"\\|,.<>/?]).{12,}$/, {
...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(1, { message: 'El apellido es obligatorio' }),
    (0, class_validator_1.MaxLength)(100),
    __metadata("design:type", String)
