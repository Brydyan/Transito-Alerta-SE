...
| 0049 | citizen_social_features | incident_followers + incident_corroborations tables; register new permissions; grant to staff roles via roles.permissions + backfill users.permissions (D5); bump permission_version for Redis invalidation. Rollback: database/rollback/0049_citizen_social_features.DOWN.sql | ⏳ Pending | — | — | — |
